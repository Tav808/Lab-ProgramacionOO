...
public class Empleado {
    ...
    public Empleado(String nombre, String apellido, int dni, String cargo, double salario, boolean activo) {
        this.nombre = nombre;
        this.apellido = apellido;
        this.dni = dni;
        this.cargo = cargo;
    ...
    public Empleado(int id, String nombre, String apellido, int dni, String cargo, double salario) {
        this.id = id;
        this.nombre = nombre;
        this.apellido = apellido;
        this.dni = dni;
