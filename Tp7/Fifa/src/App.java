...
public class App {
    public static void main(String[] args) {
        ...
        seleccion.contarPorEquipo("Boca Juniors");
        System.out.println();
        ...
        seleccion.contarPorPosicion("Defensor");
        seleccion.contarPorPosicion("Mediocampista");
        seleccion.contarPorPosicion("Delantero");
        System.out.println();
        seleccion.buscarPorPosicion(0);
        System.out.println();
        seleccion.mostrarCantidadTotal();
        System.out.println();
        Jugador nuevoJugador = new Jugador("Lautaro Blanco", 27, "Defensor", "Boca Juniors", false);
